...
@router.post("/produtos", response_model=ProdutosSchema) # Request
async def inserir_produtos(produto: ProdutosSchema, db: Session = Depends(get_db)):
...
@router.delete("/produtos/{produto_id}", response_model=ProdutosSchema) # Request
...
@router.put("/produtos/{produto_id}", response_model=ProdutosSchema) # Request
async def atualizar_produto(produto_id: int, produto_data: ProdutosSchema, db: Session = Depends(get_db)):

...
# Caminho absoluto para o diretório atual (onde o config.py está)
base_dir = Path(__file__).parent

# Caminho completo do arquivo .env
dotenv_path = base_dir / ".env"

# Carregar o .env usando o caminho completo
...
logging.info(f"POSTGRES_USER: {db_user}")
